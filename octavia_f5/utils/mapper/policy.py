...
class L7PolicyMapper(partition.PartitionMapper):
    def _get_l7policy_name(self, policy):
        return constants.PREFIX_POLICY + policy.id

    def get_l7policy_path(self, loadbalancer, policy):
        name = self._get_l7policy_name(policy)
