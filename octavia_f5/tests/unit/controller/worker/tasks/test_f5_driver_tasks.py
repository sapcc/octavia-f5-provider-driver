...
@mock.patch('octavia_f5.controller.worker.tasks.f5_driver_tasks.LOG')
@mock.patch('oslo_utils.uuidutils.generate_uuid', return_value=AMP_ID)
@mock.patch('stevedore.driver.DriverManager.driver')
class TestF5DriverTasks(base.TestCase):

    def setUp(self):

        _LB_mock.bigip = [_bigip_mock]
        _LB_mock.id = LB_ID
        conf = oslo_fixture.Config(cfg.CONF)
        super(TestF5DriverTasks, self).setUp()
    ...
    def test_listener_update(self,
        ...
        listener_update_obj = f5_driver_tasks.ListenersUpdate()
        listener_update_obj.execute(_load_balancer_mock, [_listener_mock], _bigip_mock)
    ...
    def test_listeners_update(self,
                              ...
                              mock_listener_repo_update,
                              mock_amphora_repo_update):
        listeners_update_obj = f5_driver_tasks.ListenersUpdate()
    ...
    def test_listener_delete(self,
        ...
        listener_delete_obj = f5_driver_tasks.ListenerDelete()
    ...
    def test_amphora_get_info(self,
        ...
        amphora_get_info_obj = f5_driver_tasks.AmphoraGetInfo()
    ...
    def test_amphora_get_diagnostics(self,
        ...
        amphora_get_diagnostics_obj = (f5_driver_tasks.
    ...
    def test_amphora_finalize(self,
        ...
        amphora_finalize_obj = f5_driver_tasks.AmphoraFinalize()
    ...
    def test_amphora_post_network_plug(self,
        ...
        amphora_post_network_plug_obj = (f5_driver_tasks.
    ...
    def test_amphora_post_vip_plug(self,
        ...
        amphora_post_vip_plug_obj = f5_driver_tasks.AmphoraPostVIPPlug()
    ...
    def test_amphorae_post_vip_plug(self,
        ...
        amphorae_net_config_mock = mock.Mock()
        amphora_post_vip_plug_obj = f5_driver_tasks.AmphoraePostVIPPlug()
    ...
    def test_amphora_cert_upload(self,
        ...
        amphora_cert_upload_mock = f5_driver_tasks.AmphoraCertUpload()
    ...
    def test_amphora_update_vrrp_interface(self,
        ...
        amphora_update_vrrp_interface_obj = (
            f5_driver_tasks.AmphoraUpdateVRRPInterface())
    ...
    def test_amphora_vrrp_update(self,
        ...
        amphora_vrrp_update_obj = (
            f5_driver_tasks.AmphoraVRRPUpdate())
    ...
    def test_amphora_vrrp_stop(self,
        ...
        amphora_vrrp_stop_obj = (
            f5_driver_tasks.AmphoraVRRPStop())
    ...
    def test_amphora_vrrp_start(self,
        ...
        amphora_vrrp_start_obj = (
            f5_driver_tasks.AmphoraVRRPStart())
    ...
    def test_amphora_compute_connectivity_wait(self,
        ...
        amp_compute_conn_wait_obj = (
            f5_driver_tasks.AmphoraComputeConnectivityWait())
