...
class F5Flows(object):
    ...
    def make_remove_l2_guest_flow(self, store: dict) -> flow.Flow:
        """
        ...
        remove_l2_guest_flow = linear_flow.Flow(f'remove-l2-guest-flow-{bigip_hostname}')
        remove_l2_guest_flow.add(remove_subnet_routes_subflow,
